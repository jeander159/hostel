...
<div class="modal fade" id="modalEstadisticasMes" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
       <div class="modal-dialog modal-lg">
          <div class="modal-content">
	         <div class="box box-primary">
	            <div class="modal-header">
	              <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
	              <h4 class="box-title">ESTADISTICAS POR MES</h4>
	            </div>            
	            <div class="box-body">
                <h5 class="box-title text-center">CAPACIDAD DE ALOJAMIENTO OFERTADA / UTILIZADA Y TARIFAS DEL MES</h5>
                    ...
                    <table class="table table-bordered table-hover tabla-estadistica">
                      ...
                      <tr>
                        ...
                        <td>Día 23</td>
                        <td><?php foreach (($arriboDia23[0]) as  $value) {
                            echo $value;
                          } ?></td>
                        <td>Día 24</td>
                        <td><?php foreach (($arriboDia24[0]) as  $value) {
                            echo $value;
                          } ?></td>
                      </tr>
                      <tr>
